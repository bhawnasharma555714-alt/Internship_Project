    ...
    <Layout>
      <div className="min-h-[80vh] flex items-center justify-center px-4 sm:px-6">
        <div className="rounded-2xl shadow-lg p-8 sm:p-10 max-w-2xl w-full text-center">
          <img src={Error} alt="Page Not Found" className="h-60 w-60 md:w-70 md:h-70 mx-auto"/>

          <h1 className="mt-6 text-4xl sm:text-5xl font-bold text-white">Oops!</h1>

          <h2 className="mt-2 text-2xl sm:text-3xl font-semibold text-sky-500">Page Not Found</h2>
