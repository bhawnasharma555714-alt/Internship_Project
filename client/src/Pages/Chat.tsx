    ...
    <Layout>
        ...
        {chatError ? (
            <div className="max-w-2xl mx-auto border-4 border-slate-700 mt-10 p-10 text-center rounded-2xl">
                ...
                <button
                    onClick={() => navigate(`/projects/${projectId}`)}
                    className="mt-6 bg-sky-700 text-white font-medium px-6 py-3 rounded-lg hover:bg-sky-600 transition-colors"
                >
                    Back to Project
                </button>
            </div>
        ) : (
            <div className="max-w-2xl mx-auto border-4 border-slate-700 rounded-2xl overflow-hidden hover:border-slate-600 hover:shadow-[0_0_20px_rgba(14,165,233,0.08)]">
                ...
                {/* Messages */}
                <div className="h-500px overflow-y-auto p-6 bg-slate-900/50 flex flex-col gap-3">
                ...
                <div className="bg-slate-800/70 border-t border-slate-700 p-4 flex gap-3">
                    ...
                    <button
                        onClick={sendMessage}
                        className="bg-sky-700 text-white font-medium px-6 py-3 rounded-lg hover:bg-sky-600 transition-colors"
                    >
                        Send
                    </button>
